...
def query_wander_case_records(start_time: str, end_time: str, branches: Sequence[str] | None, page_num: int, page_size: int):
    return query_special_case_records(CASE_TYPE, CASE_LABEL, CASE_KEYWORDS, start_time, end_time, branches, page_num, page_size)


def export_wander_case_records(export_format: str, start_time: str, end_time: str, branches: Sequence[str] | None):
