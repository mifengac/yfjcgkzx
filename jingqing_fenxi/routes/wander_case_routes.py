...
from jingqing_fenxi.service.wander_case_service import (
    defaults_payload,
    export_wander_case_records,
    query_wander_case_records,
)


@jingqing_fenxi_bp.route('/api/wander-case/defaults', methods=['GET'])
def api_wander_case_defaults() -> Response:
    try:
...
@jingqing_fenxi_bp.route('/api/wander-case/query', methods=['POST'])
def api_wander_case_query() -> Response:
...
@jingqing_fenxi_bp.route('/download/wander-case')
def download_wander_case() -> Response:
    ...
    try:
        export_file, mimetype, download_name = export_wander_case_records(
            export_format=fmt,
